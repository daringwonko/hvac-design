...
const navigation = [
  ...
  { name: 'HVAC', path: '/hvac', icon: HVACIcon },
  { name: 'Electrical', path: '/electrical', icon: ElectricalIcon },
  { name: 'Plumbing', path: '/plumbing', icon: PlumbingIcon },
...
function HVACIcon() {
  return (
    <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M8 8h2m4 0h2M8 11h8" />
    </svg>
  )
}
